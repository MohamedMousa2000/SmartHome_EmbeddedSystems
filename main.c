    ...
    while((AdminLogin) || (UserLogin))
    {
        ...
        if ((DIO_GET_PIN_VAL(DIO_PORTB, DIO_PIN0) == 1) && (UserLogin))      //User PB
        {
            ...
            switch(UserOrder)
            {
                ...
                case '4': LCD_clear(); DIO_SET_PIN_VAL(DIO_PORTA, DIO_PIN0, DIO_PIN_HIGH); LCD_writeString("Dimmer is ON"); break;
        ...
        else if((DIO_GET_PIN_VAL(DIO_PORTD, DIO_PIN6) == 1) && (AdminLogin)) //Admin PB
        {
            ...
            switch(AdminOrder)
            {
                ...
                case '4': DIO_SET_PIN_VAL(DIO_PORTA, DIO_PIN0, DIO_PIN_HIGH); UART_TransmitDataString("Dimmer is ON"); break;
